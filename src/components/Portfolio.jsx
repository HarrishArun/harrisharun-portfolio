...
const Portfolio = () => {
    const portfolio=[
     
        {
            ...
            description:'Expertly-crafted Flutter app showcasing my skills with clean, production-grade architecture',
        },
        {
            id:2,
            src:nikeclone,
            ...
            description:'Replicated a website to showcase proficiency in React and Tailwind CSS.',
        },
        {
            id:3,
            src:movieland,
            ...
            description:'A movie application built using OMDB API, React, and Tailwind CSS',
        },
        {
            id:4,
            src:retail,
            ...
            description:'Full-stack AI-powered application developed for a hackathon (Team Project)',
        },
        {
            id:5,
            src:portfoio,
            ...
            language:'React',
            style:'bg-white',
            code:'https://play.google.com/store/apps/developer?id=HarrishArun',
            demo:'./',
            description:'Artfully designed portfolio website created as part of the web development learning journey',
        },
        {
            id:6,
            ...
            description:'Recreated the Myntra app during the journey of learning Flutter',
        },
        {
            id:7,
            ...
            description:'Developed a movie recommender system based on content and user preferences during my internship at codsoft',
        },
        {
            id:8,
            ...
            description:'Developed a traffic sign and speed limit recognition system using OpenCV during my AI ADAS internship at IBM Skillsbuild',
        },
        {
            id:9,
            ...
            description:'A study on securing Bitcoin\'s future with crystal-based Kyber post-quantum encryption for Proof of Work (PoW) and digital signatures (Team Project)',
        },
        {
            id:10,
            ...
            description:'Well-designed full-stack application enabling users to stay updated on recent offers from their preferred e-commerce platformss',
        },
        {
            id:11,
            ...
            description:'Python-based voice assistant designed for Windows using its libraries',
        }, {
            id:11,
            ...
            description:'Created a mock website in Figma to showcase my UI/UX skills, soon to be deployed',
        }
    ]
  return (
    <div name='portfolio' className=' bg-gradient-to-b to-black from-gray-800 w-full text-white md:h-full flex items-centes justify-center '>
        <div className='max-w-screen-lg p-4 mx-auto flex flex-col justify-center  w-full md:m-16  '>
            <div className='pb-8 '>
            <p className='text-4xl font-bold inline border-b-4 border-gray-500'>Projects</p>
            <p className='py-4'>Check out my recent works here</p></div>
           
            <div className='grid sm:grid-cols-2 md:grid-cols-3 gap-8 px-12 sm:px:0 '>
         
                            
                            {portfolio.map(({id,src,demo,code,title,language,style,description})=>(<div key={id} className="card hover:scale-105 duration-500 bg-base-100 shadow-xl shadow-gray-800  border border-gray-700">
  <figure><img src={src} /></figure>
  <div className="card-body">
    <h2 className="card-title">
      {title}
      <div className={`badge ${style}`}>{language}</div>
    </h2>
    <p>{description}</p>
    <div className="card-actions justify-end">
      <a href={demo}target="_blank"
              rel="noreferrer"><div className="badge badge-outline">Demo</div></a> 
     <a href={code}target="_blank"
              rel="noreferrer"> <div className="badge badge-outline">Code</div></a>
    </div>
  </div>
</div>))}
